...
2.1. REGISTERED — заказ зарегистрирован, но вознаграждение не рассчитано;
2.2. INVALID — заказ не принят к расчёту, и вознаграждение не будет начислено;
2.3. PROCESSING — расчёт начисления в процессе;
2.4. PROCESSED — расчёт начисления окончен;
